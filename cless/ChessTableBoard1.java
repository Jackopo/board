...
public final class ChessTableBoard1 implements ChessBoard {
	 ...
	 */
	public ChessTableBoard1 (final byte rankCount, final byte fileCount) {
		super();
	 ...
	 */
	public ChessTableBoard1 (final char[][] pieceMatrix, final short moveClock, final byte reversibleMoveClock, final boolean[] castlingAbilities, final short passingPawnPosition) {
	 ...
	 */
	@Override
	public ChessTableBoard1 clone () {
		final ChessTableBoard1 clone;
		try {
			clone = (ChessTableBoard1) super.clone();
	...
	public void reset (String textRepresentation) {
		...
		final ChessTableBoard1 boardTemplate = ChessXfenCodec.decode(ChessTableBoard1.class, textRepresentation);
